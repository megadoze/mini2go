      ...
      try {
        ...
        results.forEach((r) => {
          ...
          const items = (r.locations || []).map((l: any) => {
            ...
            const value = `${r.country.id}::${locationName}`;
  ...
  return (
    ...
    <section className="relative flex flex-col min-h-svh overflow-hidden">
      ...
      <div className="flex justify-center relative z-10 w-full px-4 sm:px-6 lg:px-10 py-6 md:py-10 mt-32">
        <div className="flex flex-col items-center text-center max-w-4xl gap-3">
          <motion.h1
            className="font-roboto-condensed font-bold tracking-[0.01em] leading-tight text-5xl sm:text-5xl lg:text-7xl text-shadow px-2 py-3 rounded w-auto max-w-full"
