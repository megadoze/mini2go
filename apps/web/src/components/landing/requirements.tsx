...
export const RequirementsSection = () => {
  return (
    <section id="minimum-requirements" className="bg-white">
      <div className="px-[3vw] sm:px-6 lg:px-10 md:pt-20 pb-20">
        ...
        <div className="mt-10 md:mt-18 w-full max-w-[1200px] mx-auto flex flex-wrap justify-center gap-6 md:gap-8">
