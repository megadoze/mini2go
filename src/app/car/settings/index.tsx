...
export default function BookingSettingsSection() {
  ...
  const handleSave = async () => {
    ...
    const payload = {
      ...
      open_time: useGlobalOpenTime ? null : openTime,
      close_time: useGlobalCloseTime ? null : closeTime,
      min_rent_period: useGlobalMinDays ? null : minDays,
      max_rent_period: useGlobalMaxDays ? null : maxDays,
      interval_between_bookings: useGlobalBuffer ? null : buffer,
      age_renters: useGlobalMinAge ? null : minAge,
      min_driver_license: useGlobalLicense ? null : minLicenseYears,
      is_instant_booking: useGlobalIB ? null : instantBooking,
      is_smoking: useGlobalSmoking ? null : allowSmoking,
      is_pets: useGlobalPets ? null : allowPets,
      is_abroad: useGlobalAbroad ? null : allowAbroad,
    } as const;
    ...
    try {
      ...
      setCar((prev) => {
        ...
        return {
          ...
          minRentPeriod: payload.min_rent_period ?? null,
          maxRentPeriod: payload.max_rent_period ?? null,
          intervalBetweenBookings: payload.interval_between_bookings ?? null,
          ageRenters: payload.age_renters ?? null,
          minDriverLicense: payload.min_driver_license ?? null,
          isInstantBooking: payload.is_instant_booking ?? null,
          isSmoking: payload.is_smoking ?? null,
          isPets: payload.is_pets ?? null,
          isAbroad: payload.is_abroad ?? null,
...
//     () => ({
//       currency: car.currency ?? globalSettings?.currency ?? "EUR",
//       openTimeMin: String(car.openTime ?? 540),
//       closeTimeMin: String(car.closeTime ?? 1260),
//       minDays: String(car.minRentPeriod ?? 1),
//       maxDays: String(car.maxRentPeriod ?? 90),
//       bufferMinutes: String(car.intervalBetweenBookings ?? 0),
//       minAge: String(car.ageRenters ?? 21),
//       minLicenseYears: String(car.minDriverLicense ?? 2),
//     }),
//     [car, globalSettings?.currency]
//   );
...
//   // === Флаги Use global (NULL ⇒ true) для каждого поля
//   const [useGlobalCurrency, setUseGlobalCurrency] = useState(
//     car.currency == null
//   );
//   const [useGlobalOpenTime, setUseGlobalOpenTime] = useState(
...
//   // При включении Use global — сразу подставляем значение из globalSettings + чистим ошибку
//   useEffect(() => {
//     if (useGlobalCurrency) {
//       form.setFieldValue("currency", String(globalSettings?.currency ?? "EUR"));
//       form.clearFieldError("currency");
//     }
//   }, [useGlobalCurrency, globalSettings?.currency]);

//   const applyGlobalOnToggle = (
//     flag: boolean,
...
//     form.setFieldValue(field, String(value));
...
//       useGlobalOpenTime,
//       "openTimeMin",
//       globalSettings?.openTime
//     );
//     applyGlobalOnToggle(
//       useGlobalCloseTime,
//       "closeTimeMin",
//       globalSettings?.closeTime
//     );
//     applyGlobalOnToggle(
//       useGlobalMinDays,
//       "minDays",
...
//       globalSettings?.intervalBetweenBookings
//     );
//     applyGlobalOnToggle(useGlobalMinAge, "minAge", globalSettings?.ageRenters);
//     applyGlobalOnToggle(
//       useGlobalLicense,
//       "minLicenseYears",
...
//   // Поддержка подсказок (берём именно из globalSettings)
//   const hintCurrency = globalSettings?.currency;
//   const hintOpen = globalSettings?.openTime;
//   const hintClose = globalSettings?.closeTime;
//   const hintMinDays = globalSettings?.minRentPeriod;
...
//   // === База для dirty (Use global + переключатели)
//   const [baseUseGlobal, setBaseUseGlobal] = useState({
//     currency: useGlobalCurrency,
//     openTime: useGlobalOpenTime,
//     closeTime: useGlobalCloseTime,
...
//     setUseGlobalCurrency(ug.currency);
//     setUseGlobalOpenTime(ug.openTime);
//     setUseGlobalCloseTime(ug.closeTime);
//     setUseGlobalMinDays(ug.minDays);
//     setUseGlobalMaxDays(ug.maxDays);
//     setUseGlobalBuffer(ug.buffer);
//     setUseGlobalMinAge(ug.minAge);
//     setUseGlobalLicense(ug.license);
//     setUseGlobalIB(ug.ib);
//     setUseGlobalSmoking(ug.smoking);
//     setUseGlobalPets(ug.pets);
//     setUseGlobalAbroad(ug.abroad);
//     setBaseUseGlobal(ug);
...
//   const { toggle: toggleCurrencyGlobal } = useGlobalToggleWithDraft(
//     form,
//     "currency",
//     useGlobalCurrency,
//     setUseGlobalCurrency,
...
//   useEffect(() => {
//     if (useGlobalOpenTime) toggleOpen(true);
//   }, [useGlobalOpenTime, toggleOpen]);
...
//               }
//               checked={useGlobalCurrency}
//               onChange={(e) => toggleCurrencyGlobal(e.currentTarget.checked)}
//             />
//           </div>
//           <Select
//             data={["EUR", "USD", "GBP"]}
...
//                 }
//                 checked={useGlobalCloseTime}
//                 onChange={(e) => setUseGlobalCloseTime(e.currentTarget.checked)}
//               />
//             </div>
//             <Select
//               data={timeOptions}
...
//                 }
//                 checked={useGlobalMinDays}
//                 onChange={(e) => setUseGlobalMinDays(e.currentTarget.checked)}
//               />
//             </div>
//             <Select
//               data={minPeriodOptions}
...
//                 }
//                 checked={useGlobalMaxDays}
//                 onChange={(e) => setUseGlobalMaxDays(e.currentTarget.checked)}
//               />
//             </div>
//             <Select
//               data={maxPeriodOptions}
...
//                 }
//                 checked={useGlobalBuffer}
//                 onChange={(e) => setUseGlobalBuffer(e.currentTarget.checked)}
//               />
//             </div>
//             <Select
//               data={bufferOptions}
...
//                 }
//                 checked={useGlobalMinAge}
//                 onChange={(e) => setUseGlobalMinAge(e.currentTarget.checked)}
//               />
//             </div>
//             <Select
//               data={ageOptions}
...
//                 }
//                 checked={useGlobalLicense}
//                 onChange={(e) => setUseGlobalLicense(e.currentTarget.checked)}
//               />
//             </div>
//             <Select
//               data={licenseOptions}
